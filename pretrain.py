...
def main():
    ...
    for step in range(10):
        ...
        # 此处若外部不传入 g，则由 GateNet 根据 entropy 动态决定
        g_train = None
        ...
        # 学生路径 forward，且计算 teacher latent（compute_teacher_latent=True）
        seq_out_predictions = model(
            seq_prompt,
            current_K,
            g=g_train,
            gold_span=gold_span,
        ...
        # L_latent：student 与 teacher latent 的 L2 loss
        ...
        # L_token：通过 student 在 span 上计算 CE loss
